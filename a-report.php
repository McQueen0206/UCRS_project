...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-ungu w3-card" style="z-index:3;width:250px;" id="mySidebar">
	...
	<a href="a-report.php" class="w3-bar-item w3-button w3-white">
...
<div class="w3-container w3-content w3-xlarge " style="max-width:1000px;"><b> Report</b></div>
...
<div class="w3-container">
	...
	<div class="w3-container w3-content  w3-padding-16 " style="max-width:1000px;">    
		...
		<div class="w3-row " style="max-width:600px;">
			...
			<a href="report-event.php" target="_blank" class="w3-button w3-round w3-blue"><i class="fa fa-print w3-margin-right"></i> Event report</a>
			<div class="w3-padding"></div>
			<a href="report-membership.php" target="_blank" class="w3-button w3-round w3-blue"><i class="fa fa-print w3-margin-right"></i> Membership report</a>
