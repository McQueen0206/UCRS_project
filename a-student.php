...
{	
	...
	$SQL_insert = " 		
		INSERT INTO `student`(`id_student`, `name`, `student_id`, `password`, `email`, `phone`, `year_study`, `course`) 
				VALUES (NULL, '$name', '$student_id', '$hashed_password', '$email', '$phone', '$year_study', '$course')
	";	
...
{	
	...
	//print "<script>self.location='student.php';</script>";
}
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-ungu w3-card" style="z-index:3;width:250px;" id="mySidebar">
	...
	<a href="a-student.php" class="w3-bar-item w3-button w3-white">
...
<div class="w3-container">
	...
	<div class="w3-container w3-content w3-white w3-card w3-padding-16 w3-round" style="max-width:1000px;">    
	  ...
	  <div class="w3-row w3-white w3-padding">		
		...
		<div class="w3-large"><b>All Student</b></div>
      ...
      <header class="w3-container "> 
		...
		<div class="w3-container w3-padding">
			...
			<form action="" method="post" class="w3-padding">
				...
				<div class="w3-section" >					
					Year of Study *
					<input class="w3-input w3-border w3-round" type="number" name="year_study" value="<?PHP echo $data["year_study"]; ?>" placeholder="" required>
				</div>
      ...
      <div class="w3-container w3-padding">
		...
		<form action="" method="post" class="w3-padding">
			...
			<hr>
				...
				<div class="w3-section" >					
					Year of Study *
					<input class="w3-input w3-border w3-round" type="number" name="year_study" value="" placeholder="" required>
				</div>
