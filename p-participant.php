...
$id_event	= (isset($_REQUEST['id_event'])) ? trim($_REQUEST['id_event']) : '0';	

$sql_event 	= " SELECT * FROM `event` WHERE `id_event` =  $id_event";
$rst_event 	= mysqli_query($con, $sql_event);
$dat_event	= mysqli_fetch_array($rst_event);
$event_name	= $dat_event["event_name"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="w3-container">
	...
	<div class="w3-container w3-content w3-white w3-card w3-padding-16 w3-round" style="max-width:1000px;">    
	  ...
	  <div class="w3-row w3-white w3-padding">		
		...
		<div class="w3-large"><b>Participant of <?PHP echo $event_name;?></b></div>
		...
		<table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
			...
			<?PHP
			$bil = 0;
			$SQL_list = "SELECT * FROM `event_join`,`event`,`student` WHERE event_join.id_event = event.id_event AND event_join.id_student = student.id_student AND event_join.id_event = $id_event";
